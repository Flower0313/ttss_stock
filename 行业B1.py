...
SELECT
   distinct a.ds,
    ...
    a.up_down_rate,
    a.deal_vol,
    100.0 * (a.highest - a.lowest) / NULLIF(a.lowest,0) AS amplitude
...
result = df_all[
   # (df_all['amplitude'] <= 7) &  # 振幅 ≤ 7
    ...
    (df_all['ds'] == '2025-12-02')  # 只看 2025-09-24
    ][[
    'ds', 'code','name', 'opening_price', 'closing_price', 'up_down_rate',
    'amplitude', 'deal_vol','J', 'white_line', 'yellow_line'
]]
