...
def get_all_kline(market_code_str, con):
    ...
    params = {
        ...
        'klt': '101',  # 日k线
        'fqt': '1',  # 1才是真实的k线
        'beg': '20251203',  # 大于等于datetime.today().strftime("%Y%m%d")
        'end': '20251203',  # 小于等于datetime.today().strftime("%Y%m%d")
    ...
    try:
        ...
        con.execute('''
                INSERT INTO df_a_industry_sector_history_df 
...
def get_all_sector():
    ...
    cookies = {
        ...
        'websitepoptg_api_time': '1761974076578',
        'st_si': '76434073187247',
        'st_asi': 'delete',
        'fullscreengg': '1',
        'fullscreengg2': '1',
        ...
        'st_sn': '3',
        'st_psi': '2025110114355932-113200301321-4568533871',
    }
    ...
    headers = {
        ...
        # 'Cookie': 'qgqp_b_id=cbaf91ab2a32ba754f9ff83b95ca890b; st_nvi=egZQSMgtTClr1cqkCuwnXe6c6; nid=03758b4bcce6f57e45d38a2ba747596b; nid_create_time=1756130511737; gvi=zUCjQOcq0sJpK-BBB5Cmr5255; gvi_create_time=1756130511737; mtp=1; sid=131578758; vtpst=|; emshistory=%5B%22xd%E8%B5%9B%E5%8A%9B%E6%96%AF%22%2C%22%E5%A4%A9%E5%92%8C%E7%A3%81%E6%9D%90%22%5D; ct=FT3ki4qamnZ3ZBIYTkMjBtfGHflrYMBSxOzaJuay1ZmCuv0COdNwch5ksCpoYJYbdeEDuBLLJm-O_fn0jqgwh7W2U1WZZJ81TAFGixXeQT7mIWBrUs5NzFaOTMwfLHtVG6hBF1j2RDyTrDKXAjobDfZo0OajUQMz3NxN9XGUiLE; ut=FobyicMgeV4n4cCT8MJKZOhRZpPnvGrbz_B_nVAvVyBqu1HKh8C_X-DZIbMu0e-69SQKPieUWG7iAtaVxvX2gHxvUsl0Ij-Dx93k5eQgcELPnYGC38fl2w37MaBNh7wkezhFuExwif1d0VqnJCI_ppvxQqVdpMja08rqvec05cwi8d9ITNGrl74x3SiqaZ-shoxBo22_C0p-qJqrNwPXofKOtdA6FsCIvMZ0euqvJBoAMdSX2-_YZvdXb1yjNE8AhdQ77Pabq_y9OrC-1CeWFe87Zts2Gt1f; websitepoptg_api_time=1761974076578; st_si=76434073187247; st_asi=delete; fullscreengg=1; fullscreengg2=1; st_pvi=80850450855664; st_sp=2025-08-25%2022%3A01%3A51; st_inirUrl=https%3A%2F%2Fwww.baidu.com%2Flink; st_sn=3; st_psi=2025110114355932-113200301321-4568533871',
    }
